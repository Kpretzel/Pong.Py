...
gadget_pair = 1
ch = int(input("Choose Your Gadget Pair: "))
if ch == 1:
    gadget_pair = 1
elif ch == 2:
    gadget_pair = 2
...
while run:
    ...
    if ball_x >= WIDTH - radius:
        ...
        if dir == 0:
            if ang == 0:
                ball_vel_y, ball_vel_x = -1.0, 0.5
                dummy_ball_vel_y, dummy_ball_vel_x = -1.0, 0.5
            if ang == 1:
                ball_vel_y, ball_vel_x = -0.5, 0.5
                dummy_ball_vel_y, dummy_ball_vel_x = -0.5, 0.5
            if ang == 2:
                ball_vel_y, ball_vel_x = -0.5, 1.0
                dummy_ball_vel_y, dummy_ball_vel_x = -0.5, 1.0
